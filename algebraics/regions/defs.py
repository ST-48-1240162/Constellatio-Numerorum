...
NUMBER_TAGS: tuple[NumberTag, ...] = (
    ...
    NumberTag(3000, 1080, 40, r"$5/2$", 3000, 990),
    NumberTag(3216, 1080, 44, r"$3$", 3216, 990),
    NumberTag(3648, 1080, 44, r"$4$", 3648, 990),
    NumberTag(840, 1080, 40, r"$-5/2$", 840, 990),
    NumberTag(624, 1080, 44, r"$-3$", 624, 990),
    NumberTag(192, 1080, 44, r"$-4$", 192, 990),
    NumberTag(2531, 1080, 30, r"$\sqrt{2}$", 2531, 1175, "ma"),
    NumberTag(1309, 1080, 30, r"$-\sqrt{2}$", 1309, 1175, "ma"),
    NumberTag(2619, 1080, 34, r"$\varphi$", 2650, 955, "la"),
    NumberTag(1653, 1080, 34, r"$1-\varphi$", 1653, 990),
    NumberTag(1920, 469, 28, r"$i\sqrt{2}$", 1975, 440, "la"),
    NumberTag(1920, 1691, 28, r"$-i\sqrt{2}$", 1975, 1662, "la"),
    NumberTag(1920, 332, 26, r"$i\sqrt{3}$", 1975, 303, "la"),
    NumberTag(1920, 1828, 26, r"$-i\sqrt{3}$", 1975, 1799, "la"),
    NumberTag(1920, 216, 30, r"$2i$", 1975, 187, "la"),
    NumberTag(1920, 1944, 30, r"$-2i$", 1975, 1915, "la"),
    NumberTag(1920, 1512, 40, r"$-i$", 1975, 1483, "la"),
    NumberTag(1704, 706, 32, r"$e^{2\pi i/3}$", 1750, 660, "la"),
    NumberTag(1704, 1454, 32, r"$e^{-2\pi i/3}$", 1750, 1410, "la"),
)
